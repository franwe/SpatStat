...
spplot(guerry, "Suicids", main="Suicides [in 10.000]")
```
...
legend(x="bottom",cex=1,fill=attr(cols,"palette"),bty="n",legend=names(attr(cols, "table")),title="Residuals from Linear Regression",ncol=5)
```

**TODO: Moron manual ?? Meinst du Moran's I :)**
...
**TODO: whats the difference? to moran below? , Interpretation**
**Warum moran with residuals? mc nicht?**
